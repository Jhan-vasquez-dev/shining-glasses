...
public final class UnsignedKt {
    ...
    public static final int m674uintDivideJ1ME1BU(int i, int i2) {
        return UInt.m421constructorimpl((int) ((((long) i) & 4294967295L) / (((long) i2) & 4294967295L)));
    }

    /* JADX INFO: renamed from: uintRemainder-J1ME1BU, reason: not valid java name */
    public static final int m675uintRemainderJ1ME1BU(int i, int i2) {
        return UInt.m421constructorimpl((int) ((((long) i) & 4294967295L) % (((long) i2) & 4294967295L)));
    }

    /* JADX INFO: renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m676ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return ulongCompare(j, j2) < 0 ? ULong.m499constructorimpl(0L) : ULong.m499constructorimpl(1L);
        }
        if (j >= 0) {
            return ULong.m499constructorimpl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        return ULong.m499constructorimpl(j3 + ((long) (ulongCompare(ULong.m499constructorimpl(j - (j3 * j2)), ULong.m499constructorimpl(j2)) < 0 ? 0 : 1)));
    }

    /* JADX INFO: renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m677ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return ulongCompare(j, j2) < 0 ? j : ULong.m499constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m499constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (ulongCompare(ULong.m499constructorimpl(j3), ULong.m499constructorimpl(j2)) < 0) {
            j2 = 0;
        }
        return ULong.m499constructorimpl(j3 - j2);
    }
    ...
    public static final int doubleToUInt(double d) {
        ...
        if (d <= 2.147483647E9d) {
            return UInt.m421constructorimpl((int) d);
        }
        return UInt.m421constructorimpl(UInt.m421constructorimpl((int) (d - ((double) Integer.MAX_VALUE))) + UInt.m421constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double d) {
        ...
        if (d < 9.223372036854776E18d) {
            return ULong.m499constructorimpl((long) d);
        }
        return ULong.m499constructorimpl(ULong.m499constructorimpl((long) (d - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
