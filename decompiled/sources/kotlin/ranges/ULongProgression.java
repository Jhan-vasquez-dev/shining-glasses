...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m1517getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public boolean isEmpty() {
        ...
        long first = getFirst();
        long last = getLast();
        return j > 0 ? UnsignedKt.ulongCompare(first, last) > 0 : UnsignedKt.ulongCompare(first, last) < 0;
    }
    ...
    public boolean equals(Object other) {
        ...
        return getFirst() == uLongProgression.getFirst() && getLast() == uLongProgression.getLast() && this.step == uLongProgression.step;
    }
    ...
    public int hashCode() {
        ...
        int iM499constructorimpl = ((((int) ULong.m499constructorimpl(getFirst() ^ ULong.m499constructorimpl(getFirst() >>> 32))) * 31) + ((int) ULong.m499constructorimpl(getLast() ^ ULong.m499constructorimpl(getLast() >>> 32)))) * 31;
        long j = this.step;
        return iM499constructorimpl + ((int) (j ^ (j >>> 32)));
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            sbAppend = new StringBuilder().append((Object) ULong.m544toStringimpl(getFirst())).append("..").append((Object) ULong.m544toStringimpl(getLast())).append(" step ");
            j = this.step;
        } else {
            sbAppend = new StringBuilder().append((Object) ULong.m544toStringimpl(getFirst())).append(" downTo ").append((Object) ULong.m544toStringimpl(getLast())).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1540fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
