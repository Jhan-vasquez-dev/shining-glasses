...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int i, int i2, int i3) {
        ...
        this.first = i;
        this.last = UProgressionUtilKt.m1518getProgressionLastElementNkh28Cs(i, i2, i3);
        this.step = i3;
    }
    ...
    public String toString() {
        ...
        int i;
        if (this.step > 0) {
            sbAppend = new StringBuilder().append((Object) UInt.m466toStringimpl(getFirst())).append("..").append((Object) UInt.m466toStringimpl(getLast())).append(" step ");
            i = this.step;
        } else {
            sbAppend = new StringBuilder().append((Object) UInt.m466toStringimpl(getFirst())).append(" downTo ").append((Object) UInt.m466toStringimpl(getLast())).append(" step ");
            i = -this.step;
        }
