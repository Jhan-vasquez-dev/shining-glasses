...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m1514getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object result) {
        synchronized (this) {
            this.result = Result.m326boximpl(result);
            notifyAll();
    ...
    public final void await() {
        synchronized (this) {
            while (true) {
                Result<Unit> resultM1514getResultxLWZpok = m1514getResultxLWZpok();
                if (resultM1514getResultxLWZpok == null) {
                    wait();
                } else {
                    ResultKt.throwOnFailure(resultM1514getResultxLWZpok.getValue());
                }
            }
        }
    }
