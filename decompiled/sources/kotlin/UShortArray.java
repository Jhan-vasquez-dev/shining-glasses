...
public final class UShortArray implements Collection<UShort>, KMappedMarker {
    ...
    public static final /* synthetic */ UShortArray m655boximpl(short[] sArr) {
        return new UShortArray(sArr);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static short[] m657constructorimpl(short[] storage) {
        Intrinsics.checkNotNullParameter(storage, "storage");
        return storage;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m660equalsimpl(short[] sArr, Object obj) {
        return (obj instanceof UShortArray) && Intrinsics.areEqual(sArr, ((UShortArray) obj).getStorage());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m661equalsimpl0(short[] sArr, short[] sArr2) {
    ...
    public static int m664hashCodeimpl(short[] sArr) {
        return Arrays.hashCode(sArr);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m668toStringimpl(short[] sArr) {
    ...
    public boolean m669addxj2QHRw(short s) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public boolean equals(Object obj) {
        return m660equalsimpl(this.storage, obj);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return m664hashCodeimpl(this.storage);
    }
    ...
    public String toString() {
        return m668toStringimpl(this.storage);
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UShort) {
            return m670containsxj2QHRw(((UShort) obj).getData());
        }
        return false;
    }
    ...
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static short[] m656constructorimpl(int i) {
        return m657constructorimpl(new short[i]);
    }

    /* JADX INFO: renamed from: get-Mh2AYeg, reason: not valid java name */
    public static final short m662getMh2AYeg(short[] sArr, int i) {
        return UShort.m605constructorimpl(sArr[i]);
    }

    /* JADX INFO: renamed from: set-01HTLdE, reason: not valid java name */
    public static final void m667set01HTLdE(short[] sArr, int i, short s) {
        sArr[i] = s;
    }

    /* JADX INFO: renamed from: getSize-impl, reason: not valid java name */
    public static int m663getSizeimpl(short[] sArr) {
        return sArr.length;
    }
    ...
    public int size() {
        return m663getSizeimpl(this.storage);
    }

    /* JADX INFO: renamed from: iterator-impl, reason: not valid java name */
    public static java.util.Iterator<UShort> m666iteratorimpl(short[] sArr) {
        return new Iterator(sArr);
    }

    @Override // java.util.Collection, java.lang.Iterable
    public java.util.Iterator<UShort> iterator() {
        return m666iteratorimpl(this.storage);
    }
    ...
    private static final class Iterator extends UShortIterator {
        ...
        public short mo672nextUShortMh2AYeg() {
            int i = this.index;
    ...
    public boolean m670containsxj2QHRw(short s) {
        return m658containsxj2QHRw(this.storage, s);
    }

    /* JADX INFO: renamed from: contains-xj2QHRw, reason: not valid java name */
    public static boolean m658containsxj2QHRw(short[] sArr, short s) {
    ...
    public boolean containsAll(Collection<? extends Object> elements) {
        ...
        return m659containsAllimpl(this.storage, elements);
    }

    /* JADX INFO: renamed from: containsAll-impl, reason: not valid java name */
    public static boolean m659containsAllimpl(short[] sArr, Collection<UShort> elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
    ...
    public static boolean m665isEmptyimpl(short[] sArr) {
        return sArr.length == 0;
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return m665isEmptyimpl(this.storage);
    }
}
