...
final class AdjustedTimeMark extends TimeMark {
    ...
    public long mo1602elapsedNowUwyO8pc() {
        return Duration.m1644minusLRDsOJo(this.mark.mo1602elapsedNowUwyO8pc(), getAdjustment());
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo1603plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1645plusLRDsOJo(getAdjustment(), duration), null);
    }
}
