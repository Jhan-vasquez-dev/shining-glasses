...
public final class DurationKt {
    ...
    private static final long m1735timesmvk6XK0(int i, long j) {
        return Duration.m1647timesUwyO8pc(j, i);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m1734timeskIfJnKk(double d, long j) {
        return Duration.m1646timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM1711getZEROUwyO8pc = Duration.INSTANCE.m1711getZEROUwyO8pc();
        ...
        if (str.charAt(length2) == 'P') {
            ...
            while (i3 < length) {
                if (str.charAt(i3) != 'T') {
                    ...
                    if (durationUnitDurationUnitByIsoChar == DurationUnit.SECONDS && iIndexOf$default > 0) {
                        ...
                        long jM1645plusLRDsOJo = Duration.m1645plusLRDsOJo(jM1711getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        ...
                        jM1711getZEROUwyO8pc = Duration.m1645plusLRDsOJo(jM1645plusLRDsOJo, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    } else {
                        jM1711getZEROUwyO8pc = Duration.m1645plusLRDsOJo(jM1711getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    }
            ...
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, Math.max(length - length2, "Infinity".length()), true)) {
                jM1711getZEROUwyO8pc = Duration.INSTANCE.m1709getINFINITEUwyO8pc();
            } else {
                boolean z5 = !z2;
                ...
                while (length2 < i) {
                    ...
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM1645plusLRDsOJo2 = Duration.m1645plusLRDsOJo(jM1711getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        ...
                        jM1711getZEROUwyO8pc = Duration.m1645plusLRDsOJo(jM1645plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < i) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        jM1711getZEROUwyO8pc = Duration.m1645plusLRDsOJo(jM1711getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
        ...
        return z3 ? Duration.m1661unaryMinusUwyO8pc(jM1711getZEROUwyO8pc) : jM1711getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m1609constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m1609constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m1609constructorimpl((j << 1) + ((long) i));
    }
