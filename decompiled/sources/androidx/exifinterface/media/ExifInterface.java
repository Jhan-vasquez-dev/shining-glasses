...
public class ExifInterface {
    ...
    private static final byte[] HEIF_TYPE_FTYP = {102, 116, JSONB.Constants.BC_STR_ASCII, 112};
    private static final byte[] HEIF_BRAND_MIF1 = {JSONB.Constants.BC_STR_ASCII_FIX_36, JSONB.Constants.BC_STR_ASCII_FIX_32, 102, 49};
    private static final byte[] HEIF_BRAND_HEIC = {104, 101, JSONB.Constants.BC_STR_ASCII_FIX_32, 99};
    private static final byte[] ORF_MAKER_NOTE_HEADER_1 = {79, 76, 89, JSONB.Constants.BC_STR_ASCII_FIX_4, 80, 0};
    private static final byte[] ORF_MAKER_NOTE_HEADER_2 = {79, 76, 89, JSONB.Constants.BC_STR_ASCII_FIX_4, 80, 85, 83, 0, 73, 73};
    private static final byte[] PNG_SIGNATURE = {-119, 80, JSONB.Constants.BC_STR_ASCII_FIX_5, JSONB.Constants.BC_INT32_SHORT_MAX, 13, 10, 26, 10};
    private static final byte[] PNG_CHUNK_TYPE_EXIF = {101, 88, 73, 102};
    private static final byte[] PNG_CHUNK_TYPE_IHDR = {73, JSONB.Constants.BC_INT32, JSONB.Constants.BC_INT32_SHORT_ZERO, 82};
    private static final byte[] PNG_CHUNK_TYPE_IEND = {73, 69, JSONB.Constants.BC_STR_ASCII_FIX_5, JSONB.Constants.BC_INT32_SHORT_ZERO};
    ...
    public Bitmap getThumbnailBitmap() throws Throwable {
        ...
        if (i == 1) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                ...
                int i3 = i2 * 3;
                iArr[i2] = (bArr[i3] << JSONB.Constants.BC_INT32_NUM_16) + (bArr[i3 + 1] << 8) + bArr[i3 + 2];
            }
    ...
    */
    ...
    private void saveWebpAttributes(InputStream inputStream, OutputStream outputStream) throws Throwable {
        ...
        try {
            ...
            if (i5 != 0) {
                ExifInterfaceUtils.copy(byteOrderedDataInputStream, byteOrderedDataOutputStream2, (i5 - ((bArr.length + 4) + bArr2.length)) - 8);
