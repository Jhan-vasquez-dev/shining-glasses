...
public class ConstraintLayout extends ViewGroup {
    ...
    /* JADX WARN: Type inference failed for: r24v0, types: [androidx.constraintlayout.widget.ConstraintLayout] */
            ...
            if (viewWidget2 != null) {
                ...
                if (layoutParams.isGuideline) {
                    ...
                    if (layoutParams.circleConstraint != -1) {
                        ...
                        if (i10 != -1) {
                            ConstraintWidget targetWidget6 = getTargetWidget(i10);
                            if (targetWidget6 != null) {
                                i = i15;
                                f = f3;
                                viewWidget2.immediateConnect(ConstraintAnchor.Type.LEFT, targetWidget6, ConstraintAnchor.Type.LEFT, layoutParams.leftMargin, i14);
                            } else {
                                i = i15;
                                f = f3;
                            }
                            ...
                            i = i15;
                            f = f3;
                            if (i11 != -1 && (targetWidget = getTargetWidget(i11)) != null) {
                                viewWidget2.immediateConnect(ConstraintAnchor.Type.LEFT, targetWidget, ConstraintAnchor.Type.RIGHT, layoutParams.leftMargin, i14);
                            }
                        }
                        if (i12 != -1) {
                            ConstraintWidget targetWidget7 = getTargetWidget(i12);
                            ...
                            int i16 = i;
                            if (i13 != -1 && (targetWidget2 = getTargetWidget(i13)) != null) {
                                viewWidget2.immediateConnect(ConstraintAnchor.Type.RIGHT, targetWidget2, ConstraintAnchor.Type.RIGHT, layoutParams.rightMargin, i16);
                            }
                        }
