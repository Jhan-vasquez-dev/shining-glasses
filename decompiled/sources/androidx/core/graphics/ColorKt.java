...
public final class ColorKt {
    ...
    public static final Color plus(Color plus, Color c) {
        ...
        Intrinsics.checkNotNullExpressionValue(colorCompositeColors, "ColorUtils.compositeColors(c, this)");
    ...
    public static final Color toColor(int i) {
        ...
        Intrinsics.checkNotNullExpressionValue(colorValueOf, "Color.valueOf(this)");
        return colorValueOf;
    }
