...
class FontProvider {
    ...
    static FontsContractCompat.FontInfo[] query(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) throws Throwable {
        ...
        try {
            int i = 0;
            Cursor cursorQuery = context.getContentResolver().query(uriBuild, new String[]{"_id", FontsContractCompat.Columns.FILE_ID, FontsContractCompat.Columns.TTC_INDEX, FontsContractCompat.Columns.VARIATION_SETTINGS, FontsContractCompat.Columns.WEIGHT, FontsContractCompat.Columns.ITALIC, FontsContractCompat.Columns.RESULT_CODE}, "query = ?", new String[]{fontRequest.getQuery()}, null, cancellationSignal);
            if (cursorQuery != null) {
                try {
                    if (cursorQuery.getCount() > 0) {
                        ...
                        while (cursorQuery.moveToNext()) {
                            ...
                            int i4 = columnIndex5 != -1 ? cursorQuery.getInt(columnIndex5) : HttpStatus.SC_BAD_REQUEST;
                            if (columnIndex6 != -1) {
                                z = true;
