            ...
            if (b >= 0) {
                ...
                if ((b >> 5) == -2) {
                    ...
                    if (i2 <= i12) {
                        ...
                        int i13 = i8 + 1;
                        i4 = (i2 <= i13 || (commonToUtf8String[i13] & JSONB.Constants.BC_INT64_SHORT_MIN) != 128) ? 1 : 2;
                    } else {
                    ...
                    if ((b >> 3) == -2) {
                        ...
                        if (i2 <= i15) {
                            ...
                            int i16 = i8 + 1;
                            if (i2 > i16 && (commonToUtf8String[i16] & JSONB.Constants.BC_INT64_SHORT_MIN) == 128) {
                                int i17 = i8 + 2;
                                i7 = (i2 <= i17 || (commonToUtf8String[i17] & JSONB.Constants.BC_INT64_SHORT_MIN) != 128) ? 2 : 3;
                            }
                            i7 = 1;
                        } else {
