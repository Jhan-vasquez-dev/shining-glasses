...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public final byte m1878deprecated_getByte(long index) {
        ...
        while (beginIndex < endIndex) {
            ...
            if (cCharAt < 128) {
                ...
                if (cCharAt < 2048) {
                    ...
                    segmentWritableSegment$okio2.data[segmentWritableSegment$okio2.limit] = (byte) ((cCharAt >> 6) | Opcodes.CHECKCAST);
    ...
    public long indexOf(ByteString bytes, long fromIndex) throws IOException {
        ...
        if (segment != null) {
            ...
            while (j2 < size5) {
                ...
                for (int i2 = (int) ((((long) segment.pos) + j5) - j2); i2 < iMin2; i2++) {
