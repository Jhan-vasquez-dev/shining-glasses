...
public final class ASMUtils {
    ...
    static {
        ...
        String strReplace3 = ObjectWriter.class.getName().replace('.', '/');
        TYPE_OBJECT_WRITER = strReplace3;
        String strReplace4 = JSONWriter.class.getName().replace('.', '/');
        ...
        DESC_JSON_WRITER = "L" + strReplace4 + ';';
        DESC_OBJECT_READER = "L" + strReplace2 + ';';
        DESC_OBJECT_WRITER = "L" + strReplace3 + ';';
        ...
        map2.put(Integer.TYPE, "I");
        map2.put(Void.TYPE, ExifInterface.GPS_MEASUREMENT_INTERRUPTED);
        map2.put(Boolean.TYPE, "Z");
        map2.put(Character.TYPE, "C");
        map2.put(Byte.TYPE, "B");
        map2.put(Short.TYPE, ExifInterface.LATITUDE_SOUTH);
        map2.put(Float.TYPE, "F");
        map2.put(Long.TYPE, "J");
        map2.put(Double.TYPE, "D");
        map3.put(Integer.TYPE, "I");
        map3.put(Void.TYPE, ExifInterface.GPS_MEASUREMENT_INTERRUPTED);
        map3.put(Boolean.TYPE, "Z");
        map3.put(Character.TYPE, "C");
        map3.put(Byte.TYPE, "B");
        map3.put(Short.TYPE, ExifInterface.LATITUDE_SOUTH);
        ...
        for (int i = 0; i < 50; i++) {
            Class cls = clsArr[i];
            String strReplace5 = cls.getName().replace('.', '/');
            typeMapping.put(cls, strReplace5);
            descMapping.put(cls, "L" + strReplace5 + ';');
        }
