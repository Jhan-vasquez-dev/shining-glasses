...
public class JSONPathTypedMultiNamesPrefixName2 extends JSONPathTypedMultiNames {
    ...
    JSONPathTypedMultiNamesPrefixName2(JSONPath[] jSONPathArr, JSONPath jSONPath, JSONPath[] jSONPathArr2, Type[] typeArr, String[] strArr, long[] jArr, ZoneId zoneId, long j) {
        ...
        this.prefixName0 = ((JSONPathSegmentName) jSONPathTwoSegment.first).name;
        this.prefixNameHash0 = ((JSONPathSegmentName) jSONPathTwoSegment.first).nameHashCode;
        this.prefixName1 = ((JSONPathSegmentName) jSONPathTwoSegment.second).name;
        this.prefixNameHash1 = ((JSONPathSegmentName) jSONPathTwoSegment.second).nameHashCode;
    }
