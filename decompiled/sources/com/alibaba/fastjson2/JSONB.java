...
public interface JSONB {
    ...
    static <T> T parseObject(byte[] bArr, int i, int i2, Class<T> cls, SymbolTable symbolTable) {
        ...
        JSONReaderJSONB jSONReaderJSONB = new JSONReaderJSONB(contextCreateReadContext, bArr, i, i2);
        try {
            T t = (T) objectReader.readJSONBObject(jSONReaderJSONB, cls, null, 0L);
            if (jSONReaderJSONB.resolveTasks != null) {
                jSONReaderJSONB.handleResolveTasks(t);
    ...
    static byte[] toBytes(String str) {
        ...
        } else if (JDKUtils.STRING_VALUE != null && JDKUtils.STRING_CODER.applyAsInt(str) == 0 && (length = (bArrApply = JDKUtils.STRING_VALUE.apply(str)).length) <= 47) {
    ...
    public interface IO {
        ...
        static int writeEnum(byte[] bArr, int i, Enum r6, long j) {
            ...
            if ((24576 & j) != 0) {
                ...
                return writeString(bArr, i, strName);
            }
        ...
        static int writeTypeName(byte[] bArr, int i, String str, JSONWriter jSONWriter) {
            ...
            if (symbolTable != null) {
                ...
                if (ordinalByHashCode == -1 && jSONWriterJSONB.symbols != null) {
                    ordinalByHashCode = jSONWriterJSONB.symbols.get(jHashCode64);
                }
            } else {
                ordinalByHashCode = jSONWriterJSONB.symbols != null ? jSONWriterJSONB.symbols.get(jHashCode64) : -1;
            }
            if (ordinalByHashCode == -1) {
                ...
                tLongIntHashMap.put(jHashCode64, i3);
        ...
        static int writeString(byte[] bArr, int i, String str) {
            ...
            if (JDKUtils.STRING_CODER != null && JDKUtils.STRING_VALUE != null) {
                int iApplyAsInt = JDKUtils.STRING_CODER.applyAsInt(str);
        ...
        static int writeStringLatin1(byte[] bArr, int i, byte[] bArr2) {
            ...
            int length = bArr2.length;
            if (length <= 47) {
                iPutStringSizeLarge = i + 1;
                bArr[i] = (byte) (length + 73);
            } else if (length <= 2047) {
                iPutStringSizeLarge = putStringSizeSmall(bArr, i, length);
            } else {
                iPutStringSizeLarge = putStringSizeLarge(bArr, i, length);
            }
        ...
        static int writeNameRaw(byte[] bArr, int i, byte[] bArr2, long j, JSONWriter jSONWriter) {
            ...
            if (symbolTable == null || (ordinalByHashCode = symbolTable.getOrdinalByHashCode(j)) == -1) {
                ...
                if (jSONWriterJSONB.symbols != null) {
                    iPutIfAbsent = jSONWriterJSONB.symbols.putIfAbsent(j, jSONWriterJSONB.symbolIndex);
                    z = true;
                    if (iPutIfAbsent == jSONWriterJSONB.symbolIndex) {
