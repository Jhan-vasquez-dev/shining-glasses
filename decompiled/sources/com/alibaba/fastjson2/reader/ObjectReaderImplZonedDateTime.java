        ...
        if (jSONReader.isInt()) {
            ...
            if (this.formatMillis || this.formatUnixTime) {
                ...
                if (!this.formatHasHour) {
                    ...
                    zonedDateTime = ZonedDateTime.of(LocalDate.of(1970, 1, 1), LocalTime.parse(string, dateFormatter), context.getZoneId());
                } else {
                    zonedDateTime = ZonedDateTime.of(LocalDateTime.parse(string, dateFormatter), context.getZoneId());
                }
            }
        }
        Function function = this.builder;
