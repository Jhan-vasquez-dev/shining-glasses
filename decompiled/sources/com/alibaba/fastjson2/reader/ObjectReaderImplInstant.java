...
public final class ObjectReaderImplInstant extends DateTimeCodec implements ObjectReader {
    ...
    public Object readObject(JSONReader jSONReader, Type type, Object obj, long j) {
        ...
        if (!this.formatHasDay) {
            return ZonedDateTime.of(LocalDate.of(1970, 1, 1), LocalTime.parse(string, dateFormatter), context.getZoneId()).toInstant();
        }
        return ZonedDateTime.of(LocalDateTime.parse(string, dateFormatter), context.getZoneId()).toInstant();
    }
}
