            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                for (int i3 = 0; i3 < parameters2.length && i3 < strArrLookupParameterNames.length; i3++) {
                    ...
                    if (fieldInfo.fieldName != null) {
                        strArrLookupParameterNames[i3] = fieldInfo.fieldName;
                    }
                }
    ...
    public T apply(Map<Long, Object> map) {
        ...
        while (true) {
            ...
            if (map.containsKey(Long.valueOf(jArr[i2]))) {
                ...
                while (i < jArr2.length) {
                    Object defaultValue = map.get(Long.valueOf(jArr2[i]));
                    Type type = typeArr[i];
        ...
        if (this.marker) {
            ...
            while (i3 < length2) {
                ...
                Object objCast4 = map.get(Long.valueOf(this.hashCodes[i3]));
                if (objCast4 != null) {
