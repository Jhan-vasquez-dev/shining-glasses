...
class JSONReaderUTF8 extends JSONReader {
    ...
    private void char_utf8(int i, int i2) {
        ...
        switch (i4 >> 4) {
            ...
            default:
                if ((i >> 3) == -2) {
                    iChar2_utf8 = (((i << 18) ^ (bArr[i2] << 12)) ^ (bArr[i2 + 1] << 6)) ^ (bArr[i2 + 2] ^ ByteCompanionObject.MIN_VALUE);
                    i3 = i2 + 3;
                } else {
    ...
    /* JADX WARN: Removed duplicated region for block: B:35:0x005e A[LOOP:1: B:19:0x0039->B:35:0x005e, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:43:0x0033 A[EDGE_INSN: B:43:0x0033->B:17:0x0033 BREAK  A[LOOP:1: B:19:0x0039->B:35:0x005e], SYNTHETIC] */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:36:0x0065 A[LOOP:1: B:20:0x0040->B:36:0x0065, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:44:0x003a A[EDGE_INSN: B:44:0x003a->B:18:0x003a BREAK  A[LOOP:1: B:20:0x0040->B:36:0x0065], SYNTHETIC] */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:28:0x0048 A[LOOP:0: B:11:0x0019->B:28:0x0048, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:29:0x0013 A[EDGE_INSN: B:29:0x0013->B:9:0x0013 BREAK  A[LOOP:0: B:11:0x0019->B:28:0x0048], SYNTHETIC] */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:42:0x0077 A[LOOP:0: B:11:0x001b->B:42:0x0077, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:43:0x0015 A[EDGE_INSN: B:43:0x0015->B:9:0x0015 BREAK  A[LOOP:0: B:11:0x001b->B:42:0x0077], SYNTHETIC] */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:23:0x003f A[LOOP:0: B:7:0x0011->B:23:0x003f, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:24:0x000b A[EDGE_INSN: B:24:0x000b->B:5:0x000b BREAK  A[LOOP:0: B:7:0x0011->B:23:0x003f], SYNTHETIC] */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:14:0x0029  */
    /* JADX WARN: Removed duplicated region for block: B:16:0x002d  */
    /* JADX WARN: Removed duplicated region for block: B:21:0x0038 A[LOOP:0: B:7:0x0011->B:21:0x0038, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:22:0x000b A[EDGE_INSN: B:22:0x000b->B:5:0x000b BREAK  A[LOOP:0: B:7:0x0011->B:21:0x0038], SYNTHETIC] */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:42:0x009d A[FALL_THROUGH] */
    ...
    */
    ...
    public final int getRawInt() {
        if (this.offset + 3 < this.bytes.length) {
            return JDKUtils.UNSAFE.getInt(this.bytes, (JDKUtils.ARRAY_BYTE_BASE_OFFSET + ((long) this.offset)) - 1);
        }
        return 0;
    }
    ...
    public final long getRawLong() {
        if (this.offset + 8 < this.bytes.length) {
            return JDKUtils.UNSAFE.getLong(this.bytes, (JDKUtils.ARRAY_BYTE_BASE_OFFSET + ((long) this.offset)) - 1);
        }
        return 0L;
    }
    ...
    /* JADX WARN: Failed to find 'out' block for switch in B:182:0x02e5. Please report as an issue. */
    ...
    */
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:76:0x015a -> B:69:0x0142). Please report as a decompilation issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:92:0x0181 -> B:86:0x0170). Please report as a decompilation issue!!! */
    /*  JADX ERROR: JadxRuntimeException in pass: RegionMakerVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Not found exit edge by exit block: B:73:0x0150
        	at jadx.core.dex.visitors.regions.maker.LoopRegionMaker.checkLoopExits(LoopRegionMaker.java:226)
        	at jadx.core.dex.visitors.regions.maker.LoopRegionMaker.makeLoopRegion(LoopRegionMaker.java:196)
        	at jadx.core.dex.visitors.regions.maker.LoopRegionMaker.process(LoopRegionMaker.java:63)
        	at jadx.core.dex.visitors.regions.maker.RegionMaker.traverse(RegionMaker.java:89)
    ...
    public long getNameHashCodeLCase() {
                    ...
                    if ((iHexDigit42 != 95 && iHexDigit42 != 45 && iHexDigit42 != 32) || (i5 = bArr[i6 + 1]) == 34 || i5 == 39 || i5 == iHexDigit42) {
                        ...
                        switch (i9) {
                            ...
                            case 1:
                                ...
                                break;
                            case 2:
                                j = ((byte) iHexDigit42) << JSONB.Constants.BC_INT32_NUM_16;
        ...
        while (true) {
            ...
            if (iChar1 != c && iChar1 != 45 && iChar1 != c2) {
    ...
    final String getLatin1String(int i, int i2) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            andSet[i3] = (char) (this.bytes[i + i3] & UByte.MAX_VALUE);
        }
        return new String(andSet, 0, i2);
    }

    /* JADX WARN: Removed duplicated region for block: B:58:0x00dc  */
    /* JADX WARN: Removed duplicated region for block: B:58:0x00dc A[FALL_THROUGH] */
    @Override // com.alibaba.fastjson2.JSONReader
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
        ...
        while (true) {
            ...
            if (b2 == 92) {
                ...
                if (b2 == b) {
                        ...
                        while (true) {
                            ...
                            if (iHexDigit4 == b5) {
                                ...
                                if (b7 == 34 || b7 == b5) {
                                    ...
                                    iHexDigit4 = IOUtils.hexDigit4(bArr, JSONReaderJSONB.check3(i + 2, i6));
                                    i += 5;
                                } else if (b7 == b3) {
                                    byte b8 = bArr[i + 2];
                                    i += 3;
                                    iHexDigit4 = char2(b8, bArr[i]);
                                } else {
                                    iHexDigit4 = char1(b7);
                                    i = i8;
                                }
                                ...
                                if (z) {
                                    JSONWriter jSONWriterOf = JSONWriterUTF8.of();
                            ...
                            if (iHexDigit4 >= 0) {
                                ...
                                switch ((iHexDigit4 & 255) >> 4) {
                                    case 12:
                                    case 13:
                                        cArr[i7] = (char) (((iHexDigit4 & 31) << 6) | (bArr[i + 1] & 63));
                                        i += 2;
                                        break;
                                    case 14:
                                        cArr[i7] = (char) (((iHexDigit4 & 15) << 12) | ((bArr[i + 1] & 63) << 6) | (bArr[i + 2] & 63));
                                        i += 3;
                                        break;
                                    default:
                                        if ((iHexDigit4 >> 3) == -2) {
                                            ...
                                            byte b11 = bArr[i + 3];
                                            i += 4;
                                            int i9 = (((iHexDigit4 << 18) ^ (b9 << 12)) ^ (b10 << 6)) ^ (b11 ^ ByteCompanionObject.MIN_VALUE);
                                            if ((b9 & JSONB.Constants.BC_INT64_SHORT_MIN) == 128 && (b10 & JSONB.Constants.BC_INT64_SHORT_MIN) == 128 && (b11 & JSONB.Constants.BC_INT64_SHORT_MIN) == 128 && i9 >= 65536 && i9 < 1114112) {
                                                int i10 = i7 + 1;
                                                cArr[i7] = (char) ((i9 >>> 10) + Utf8.HIGH_SURROGATE_HEADER);
                                                cArr[i10] = (char) ((i9 & 1023) + Utf8.LOG_SURROGATE_HEADER);
                                                i7 = i10;
                                            }
                                        } else {
                                            throw new JSONException("malformed input around byte " + i);
                    ...
                    int i12 = i2 - this.offset;
                    if (z) {
                        i12 += 2;
                    }
                    if (z && b == 39) {
                        byte[] bArr3 = new byte[i12];
                        System.arraycopy(bArr, this.offset - 1, bArr3, 0, i12);
                        bArr3[0] = 34;
                        bArr3[i12 - 1] = 34;
                        valueConsumer.accept(bArr3, 0, i12);
                    } else {
                        valueConsumer.accept(bArr, i11, i12);
                    }
                    int i13 = i2 + 1;
                    byte b12 = bArr[i13];
            ...
            if (b2 == 92) {
                ...
                if (b2 < 0) {
                    ...
                    if (b2 == b) {
                                ...
                                if (b4 == 92) {
                                    ...
                                    switch ((b4 & UByte.MAX_VALUE) >> 4) {
                                        ...
                                        case 13:
                                            int i10 = i + 1;
                                            i += 2;
                                            cArr[i7] = (char) (((b4 & 31) << 6) | (bArr[i10] & 63));
                                            break;
                                        case 14:
                                            int i11 = i + 2;
                                            byte b6 = bArr[i + 1];
                                            i += 3;
                                            cArr[i7] = (char) (((b4 & 15) << 12) | ((b6 & 63) << 6) | (bArr[i11] & 63));
                                            break;
                                        default:
                                            if ((b4 >> 3) == -2) {
                                                byte b7 = bArr[i + 1];
                                                ...
                                                i += 4;
                                                byte b9 = bArr[i12];
                                                int i13 = (((b4 << 18) ^ (b7 << 12)) ^ (b8 << 6)) ^ (b9 ^ ByteCompanionObject.MIN_VALUE);
                                                if ((b7 & JSONB.Constants.BC_INT64_SHORT_MIN) == 128 && (b8 & JSONB.Constants.BC_INT64_SHORT_MIN) == 128 && (b9 & JSONB.Constants.BC_INT64_SHORT_MIN) == 128 && i13 >= 65536 && i13 < 1114112) {
                                                    int i14 = i7 + 1;
                                                    cArr[i7] = (char) ((i13 >>> 10) + Utf8.HIGH_SURROGATE_HEADER);
                        ...
                        if (z3) {
                            int i15 = i3 - this.offset;
                            if (JDKUtils.ANDROID) {
                                str = getLatin1String(this.offset, i15);
                            } else {
                                str = new String(bArr, this.offset, i15, StandardCharsets.ISO_8859_1);
                            }
                        } else {
    ...
    */
    ...
    jadx.core.utils.exceptions.JadxOverflowException: Type inference error: updates count limit reached with updateSeq = 7021. Try increasing type updates limit count.
    ...
    jadx.core.utils.exceptions.JadxOverflowException: Type inference error: updates count limit reached with updateSeq = 7021. Try increasing type updates limit count.
    	...
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.updateTypeForSsaVar(TypeUpdate.java:202)
     */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:130:0x0225 -> B:124:0x020c). Please report as a decompilation issue!!! */
    /*  JADX ERROR: JadxRuntimeException in pass: RegionMakerVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Not found exit edge by exit block: B:127:0x0216
        	at jadx.core.dex.visitors.regions.maker.LoopRegionMaker.checkLoopExits(LoopRegionMaker.java:226)
        	at jadx.core.dex.visitors.regions.maker.LoopRegionMaker.makeLoopRegion(LoopRegionMaker.java:196)
        	at jadx.core.dex.visitors.regions.maker.LoopRegionMaker.process(LoopRegionMaker.java:63)
        	at jadx.core.dex.visitors.regions.maker.RegionMaker.traverse(RegionMaker.java:89)
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:16:0x0056 -> B:11:0x0045). Please report as a decompilation issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:218:0x032a -> B:211:0x0315). Please report as a decompilation issue!!! */
    /*  JADX ERROR: JadxRuntimeException in pass: RegionMakerVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Not found exit edge by exit block: B:13:0x004c
        	at jadx.core.dex.visitors.regions.maker.LoopRegionMaker.checkLoopExits(LoopRegionMaker.java:226)
        	at jadx.core.dex.visitors.regions.maker.LoopRegionMaker.makeLoopRegion(LoopRegionMaker.java:196)
        	at jadx.core.dex.visitors.regions.maker.LoopRegionMaker.process(LoopRegionMaker.java:63)
        	at jadx.core.dex.visitors.regions.maker.RegionMaker.traverse(RegionMaker.java:89)
    ...
    public final LocalDate readLocalDate() {
        ...
        if ((c == '\"' || c == '\'') && !this.context.formatComplex) {
            ...
            if (i2 < bArr.length && i2 < this.end && (iYy = DateUtils.yy(bArr, i)) != -1) {
                ...
                if (jYmd != -1 && bArr[i2] == c) {
                    int i3 = iYy + (((int) jYmd) & 255);
                    int i4 = ((int) (jYmd >> 24)) & 255;
                    int i5 = ((int) (jYmd >> 48)) & 255;
                    if ((i3 | i4 | i5) == 0) {
                        localDateOf = null;
                    } else {
                        try {
    ...
    private LocalDate readLocalDate0(int i, byte[] bArr, char c) {
        ...
        LocalDate localDateOf = LocalDate.of(TypeUtils.parseInt(bArr, i, i2 - 6), IOUtils.digit2(bArr, i3 - 5), IOUtils.digit2(bArr, i3 - 2));
        this.offset = i3 + 1;
        next();
        boolean z = this.ch == ',';
        this.comma = z;
    ...
    /* JADX WARN: Removed duplicated region for block: B:77:0x0138 A[LOOP:1: B:47:0x00b5->B:77:0x0138, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:89:0x00ae A[EDGE_INSN: B:89:0x00ae->B:45:0x00ae BREAK  A[LOOP:1: B:47:0x00b5->B:77:0x0138], SYNTHETIC] */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:75:0x0134 -> B:45:0x00ae). Please report as a decompilation issue!!! */
    ...
    */
    ...
    protected final ZonedDateTime readZonedDateTimeX(int i) {
        ...
        if (i == 30 && this.bytes[this.offset + 29] == 90) {
            zonedDateTime = ZonedDateTime.of(DateUtils.parseLocalDateTime29(this.bytes, this.offset), ZoneOffset.UTC);
        } else if (i == 29 && this.bytes[this.offset + 28] == 90) {
            zonedDateTime = ZonedDateTime.of(DateUtils.parseLocalDateTime28(this.bytes, this.offset), ZoneOffset.UTC);
        } else if (i == 28 && this.bytes[this.offset + 27] == 90) {
            zonedDateTime = ZonedDateTime.of(DateUtils.parseLocalDateTime27(this.bytes, this.offset), ZoneOffset.UTC);
        } else if (i == 27 && this.bytes[this.offset + 26] == 90) {
            zonedDateTime = ZonedDateTime.of(DateUtils.parseLocalDateTime26(this.bytes, this.offset), ZoneOffset.UTC);
        } else {
    ...
    public final long readMillis19() {
        ...
        long millis19 = DateUtils.parseMillis19(this.bytes, this.offset, this.context.zoneId);
    ...
    protected final LocalDateTime readLocalDateTimeX(int i) {
        ...
        if (this.bytes[(this.offset + i) - 1] == 90) {
            localDateTimeX = DateUtils.parseZonedDateTime(this.bytes, this.offset, i).toInstant().atZone(this.context.getZoneId()).toLocalDateTime();
        } else {
            localDateTimeX = DateUtils.parseLocalDateTimeX(this.bytes, this.offset, i);
        }
        if (localDateTimeX == 0) {
            return null;
        }
    ...
    /* JADX WARN: Path cross not found for [B:190:0x028b, B:237:?], limit reached: 240 */
    /* JADX WARN: Removed duplicated region for block: B:228:0x008c A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:39:0x0093 A[LOOP:0: B:25:0x005a->B:39:0x0093, LOOP_END] */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:199:0x02ac -> B:191:0x028d). Please report as a decompilation issue!!! */
    /*  JADX ERROR: JadxRuntimeException in pass: RegionMakerVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Not found exit edge by exit block: B:196:0x02a1
        	at jadx.core.dex.visitors.regions.maker.LoopRegionMaker.checkLoopExits(LoopRegionMaker.java:226)
        	at jadx.core.dex.visitors.regions.maker.LoopRegionMaker.makeLoopRegion(LoopRegionMaker.java:196)
        	at jadx.core.dex.visitors.regions.maker.LoopRegionMaker.process(LoopRegionMaker.java:63)
        	at jadx.core.dex.visitors.regions.maker.RegionMaker.traverse(RegionMaker.java:89)
    ...
    */
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:79:0x00e7 -> B:67:0x00c4). Please report as a decompilation issue!!! */
    /*  JADX ERROR: JadxOverflowException in pass: RegionMakerVisitor
        jadx.core.utils.exceptions.JadxOverflowException: Regions count limit reached
        	at jadx.core.utils.ErrorsCounter.addError(ErrorsCounter.java:59)
        	at jadx.core.utils.ErrorsCounter.error(ErrorsCounter.java:31)
    ...
    */
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:26:0x005d -> B:20:0x004c). Please report as a decompilation issue!!! */
    /*  JADX ERROR: JadxRuntimeException in pass: RegionMakerVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Not found exit edge by exit block: B:22:0x0052
        	at jadx.core.dex.visitors.regions.maker.LoopRegionMaker.checkLoopExits(LoopRegionMaker.java:226)
        	at jadx.core.dex.visitors.regions.maker.LoopRegionMaker.makeLoopRegion(LoopRegionMaker.java:196)
        	at jadx.core.dex.visitors.regions.maker.LoopRegionMaker.process(LoopRegionMaker.java:63)
        	at jadx.core.dex.visitors.regions.maker.RegionMaker.traverse(RegionMaker.java:89)
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:101:0x0154 -> B:94:0x0142). Please report as a decompilation issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:84:0x0128 -> B:77:0x010d). Please report as a decompilation issue!!! */
    /*  JADX ERROR: JadxRuntimeException in pass: RegionMakerVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Not found exit edge by exit block: B:80:0x011d
        	at jadx.core.dex.visitors.regions.maker.LoopRegionMaker.checkLoopExits(LoopRegionMaker.java:226)
        	at jadx.core.dex.visitors.regions.maker.LoopRegionMaker.makeLoopRegion(LoopRegionMaker.java:196)
        	at jadx.core.dex.visitors.regions.maker.LoopRegionMaker.process(LoopRegionMaker.java:63)
        	at jadx.core.dex.visitors.regions.maker.RegionMaker.traverse(RegionMaker.java:89)
    ...
    public final byte[] readBase64() {
        ...
        int i3 = this.end;
        int iIndexOfQuote = IOUtils.indexOfQuote(bArr, this.ch, length, i3);
        if (iIndexOfQuote == -1) {
            throw error("invalid escape character EOI");
        }
        if (indexOfSlash(this, bArr, length, i3) != -1) {
            throw error("invalid base64 string");
        }
        if (iIndexOfQuote != length) {
            int i4 = 0;
            while (true) {
                if (i4 < "data:image/jpeg;base64,".length()) {
                    if (bArr[length + i4] != "data:image/jpeg;base64,".charAt(i4)) {
                        break;
                    }
                    i4++;
                } else {
                    length += "data:image/jpeg;base64,".length();
                    break;
                }
            }
            bArrDecode = Base64.getDecoder().decode(Arrays.copyOfRange(bArr, length, iIndexOfQuote));
        } else {
    ...
    public final String info(String str) {
        ...
        return sb.append("offset ").append(this.offset).append(", character ").append(this.ch).append(", line ").append(i).append(", column ").append(i3).append(", fastjson-version 2.0.58").append(i <= 1 ? TokenParser.SP : '\n').append(new String(this.bytes, this.start, Math.min(this.length, 65535))).toString();
    }
    ...
    public static JSONReaderUTF8 of(byte[] bArr, int i, int i2, JSONReader.Context context) {
        ...
        if (JDKUtils.METHOD_HANDLE_HAS_NEGATIVE != null) {
            try {
                zIsASCII = !(boolean) JDKUtils.METHOD_HANDLE_HAS_NEGATIVE.invoke(bArr, i, i2);
