...
public final class FDBigInteger {
    ...
    private static void mult(int[] iArr, int i, int i2, int i3, int[] iArr2) {
        ...
        while (i4 < i) {
            int i5 = i4 + 1;
            long j3 = (((long) iArr2[i5]) & 4294967295L) + ((((long) iArr[i4]) & 4294967295L) * j) + j2;
            iArr2[i5] = (int) j3;
            j2 = j3 >>> 32;
            i4 = i5;
        }
    ...
    private static FDBigInteger big5powRec(int i) {
        ...
        int[] iArr = SMALL_5_POW;
        if (i3 < iArr.length) {
            return fDBigIntegerBig5powRec.mult(iArr[i3]);
        }
    ...
    public static FDBigInteger valueOfMulPow52(long j, int i, int i2) {
        ...
        FDBigInteger fDBigIntegerBig5pow = big5pow(i);
        if (i4 == 0) {
            int i12 = fDBigIntegerBig5pow.nWords;
            iArr = new int[i12 + 1 + (i2 != 0 ? 1 : 0)];
            mult(fDBigIntegerBig5pow.data, i12, i3, iArr);
        } else {
            int i13 = fDBigIntegerBig5pow.nWords;
            iArr = new int[i13 + 2 + (i2 != 0 ? 1 : 0)];
            mult(fDBigIntegerBig5pow.data, i13, i3, i4, iArr);
        }
