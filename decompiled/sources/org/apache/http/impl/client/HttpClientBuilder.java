    ...
    public CloseableHttpClient build() {
        ...
        if (!this.connManagerShared) {
            ...
            if (this.evictExpiredConnections || this.evictIdleConnections) {
                ...
                HttpClientConnectionManager httpClientConnectionManager3 = httpClientConnectionManager;
                final IdleConnectionEvictor idleConnectionEvictor = new IdleConnectionEvictor(httpClientConnectionManager3, j2, timeUnit2, this.maxIdleTime, this.maxIdleTimeUnit);
        ...
        return new InternalHttpClient(clientExecChainDecorateProtocolExec, httpClientConnectionManager, httpRoutePlanner, lookupCreateDefault, lookupBuild, basicCookieStore, basicCredentialsProvider, requestConfig, arrayList3);
    }
}
