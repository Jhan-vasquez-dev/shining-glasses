...
import com.alibaba.fastjson2.internal.asm.ASMUtils$$ExternalSyntheticBackportWithForwarding0;
...
public class HttpServer {
    ...
    public void start() throws IOException {
        if (ASMUtils$$ExternalSyntheticBackportWithForwarding0.m(this.status, Status.READY, Status.ACTIVE)) {
    ...
    public void stop() {
        if (ASMUtils$$ExternalSyntheticBackportWithForwarding0.m(this.status, Status.ACTIVE, Status.STOPPING)) {
