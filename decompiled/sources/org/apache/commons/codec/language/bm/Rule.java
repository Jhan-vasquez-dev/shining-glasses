        ...
        for (NameType nameType : NameType.values()) {
            ...
            for (RuleType ruleType : RuleType.values()) {
                ...
                if (!ruleType.equals(RuleType.RULES)) {
                    map.put(SharedPreferenceUtils.FILE_NAME, parseRules(createScanner(nameType, ruleType, SharedPreferenceUtils.FILE_NAME), createResourceName(nameType, ruleType, SharedPreferenceUtils.FILE_NAME)));
                }
