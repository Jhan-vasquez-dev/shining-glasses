...
public final class TaskLoggerKt {
    ...
    public static final String formatDuration(long j) {
        ...
        if (j <= -999500000) {
            ...
            str = j <= 0 ? ((j - ((long) HttpStatus.SC_INTERNAL_SERVER_ERROR)) / ((long) 1000)) + " µs" : j < ((long) 999500) ? ((j + ((long) HttpStatus.SC_INTERNAL_SERVER_ERROR)) / ((long) 1000)) + " µs" : j < ((long) 999500000) ? ((j + ((long) 500000)) / ((long) DurationKt.NANOS_IN_MILLIS)) + " ms" : ((j + ((long) 500000000)) / ((long) Http2Connection.DEGRADED_PONG_TIMEOUT_NS)) + " s ";
        }
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
